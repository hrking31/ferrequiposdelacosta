...
// import { useLocation } from "react-router-dom";
// import EquipoForm from "../EquipoForm/EquipoForm"
...
//   const handleReset = () => {
//     if (equipoSeleccionado) setFormData(equipoSeleccionado);
//     setOriginalImageBeforeEdit(null);
//     setEditingImageIndex(null);
//     setEditingNameIndex(null);
//     setNuevaImagenTemporal(null);
...
//   const actualizarEquipoConCambios = async () => {
//     try {
//       const db = getFirestore();
...
//       const imagenesFinalesFiltradas = formData.images.map((img) => ({
//         name: img.name,
//         url: img.url,
//         path: img.path,
//       }));
...
//       const equipoRef = doc(db, "equipos", formData.id);
//       await updateDoc(equipoRef, datosActualizados);
...
//       <Typography
//         variant="h4"
//         sx={{ color: "#8B3A3A", fontWeight: "bold", mb: 2 }}
//       >
//         Editar el equipo
//       </Typography>
...
//         setImagenesEliminadas={setImagenesEliminadas}
//         nuevaImagenTemporal={nuevaImagenTemporal}
//         setNuevaImagenTemporal={setNuevaImagenTemporal}
//         nombreTemporal={nombreTemporal}
//         setNombreTemporal={setNombreTemporal}
//         originalImageBeforeEdit={originalImageBeforeEdit}
//         setOriginalImageBeforeEdit={setOriginalImageBeforeEdit}
...
//         </Grid>
//         <Grid item>
//           <Button variant="contained" onClick={actualizarEquipoConCambios}>
//             Guardar Equipo
//           </Button>
//         </Grid>
//       </Grid>
