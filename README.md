...
En la ficha del cliente, cada equipo lleva el rótulo de **uno de sus cinco estados** — pendiente, activo, ampliación, vencido, devuelto — encabezando su columna de la derecha, arriba de la plata. Todos miden lo mismo: el ancho del rótulo más largo, que sale de la propia lista de estados y no de un número escrito a mano, así que cambiar una palabra ajusta el ancho solo. Su forma —el relleno, el radio, la letra— vive en el tema, en `rotuloEstado`, y de ahí la toman los dos lugares que lo dibujan: la fila del equipo y cada hito de su historia. Antes solo se rotulaba el devuelto, y los otros cuatro había que deducirlos leyendo las fechas. Va con la plata y no pegado al nombre porque son las dos cosas que se leen de un vistazo: juntas se leen de una pasada, en vez de saltar de una punta a la otra de la fila.
...
> [!NOTE]
> **El estado de cuenta, en dos recuadros (2026-09-23).** Arriba, **la factura** con solo la plata que le llegó a ella: Total factura · Pago inicial (sin la parte que fue al depósito, y lo dice en letra chica) · Abonos · Pagado con el depósito · Total pagado · Saldo pendiente. Abajo, **el depósito**: recibido, lo retenido o aplicado que pasa a la factura, lo devuelto, el monto a devolver o en garantía, su estado y el botón Devolver. En "Información de pago", cuando el despacho lleva depósito, lo que entregó el cliente se llama **Total** —es lo que cuadra con el banco— y al final va **Valor**, lo que le quedó a la factura: en la 8154, Total $1.514.000 · Valor $1.014.000.
